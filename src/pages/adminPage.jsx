            ...
            <div className="w-full md:hidden">
                ...
                <div className="w-full px-2 pb-3 overflow-x-auto">
                    <div className="flex gap-2 text-sm whitespace-nowrap">
                        <Link
                            to="/admin"
                            className={`px-3 py-2 rounded-full border border-white/30 flex items-center gap-2 ${location.pathname === "/admin" || location.pathname === "/admin/" ? "bg-white text-accent" : "text-white"}`}
                        >
                            <LuClipboardList />
                            <span>Orders</span>
                        </Link>
