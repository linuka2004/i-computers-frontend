...
//   //const cart = getCart(); // <--- you MUST have your cart items
//   const orderItems = [];
...
//            }}
//            className="self-center ml-4 px-6 py-3 rounded border-2 border-secondary/30 focus:border-accent outline-none transition w-[300px]" />
//            </div>
...
//         <button onClick={submitOrder} className="px-6 py-3 rounded bg-accent text-white hover:bg-accent/90 transition">
//           Order Now
//         </button>
