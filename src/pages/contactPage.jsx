      ...
      <div className="relative h-[45vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white">
            Contact <span className="text-cyan-400">Isuri Computers</span>
          </h1>
          <p className="mt-3 text-cyan-100 max-w-xl mx-auto">
            Need hardware advice, repairs, or a custom build?  
            We’re happy to help.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="mt-6 rounded-2xl overflow-hidden shadow-lg border">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.902487211594!2d79.850086!3d6.927079!2m3!1f0!2f0!3f0"
